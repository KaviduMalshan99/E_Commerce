...
import WomenBagLogo from "../../src/assets/wb.jpg";
      ...
      {!loading && (
        <div className="men-main-container">
          ...
          <div className="men-main-image-container">
            <img src={WomenBagLogo} className="men-main-bag-logo" />
            <p className="men-main-title">SHOP WOMEN BAGS</p>
          </div>
          <p className="men-breadcrumb">
            <Link to="/">HOME</Link> <i className="fas fa-angle-right" />{" "}
            <Link to="/women-bags">WOMEN BAGS</Link>
